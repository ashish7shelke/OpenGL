...
GLfloat quad1Alpha = 1.0f;
GLfloat quad2Alpha = 1.0f;
GLfloat quad3Alpha = 1.0f;
GLfloat quad4Alpha = 1.0f;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
		...
		case 'd':
				if(quad1Alpha > 0.0f)	
					quad1Alpha = quad1Alpha - 0.05f;
				else if(quad2Alpha > 0.0f)
					quad2Alpha = quad2Alpha - 0.05f;
				else if(quad3Alpha > 0.0f)
					quad3Alpha = quad3Alpha - 0.05f;		
				else if(quad4Alpha > 0.0f)
					quad4Alpha = quad4Alpha - 0.05f;
				break;
		...
		case 'i':
				if(quad4Alpha < 1.0f)	
					quad4Alpha = quad4Alpha + 0.05f;
				else if(quad3Alpha < 1.0f)	
					quad3Alpha = quad3Alpha + 0.05f;
				else if(quad2Alpha < 1.0f)	
					quad2Alpha = quad2Alpha + 0.05f;		
				else if(quad1Alpha < 1.0f)	
					quad1Alpha = quad1Alpha + 0.05f;
				break;
...
void display(void)
{
	...
	glBegin(GL_QUADS);
	glColor4f(1.0f, 1.0f, 1.0f, quad1Alpha);
	...
	glBegin(GL_QUADS);
	glColor4f(1.0f, 1.0f, 1.0f, quad2Alpha);	
	glTexCoord2f(0.5, 1.0);
	glVertex3f(0.0f, 1.0f, 0.0f);
	...
	glBegin(GL_QUADS);
	glColor4f(1.0f, 1.0f, 1.0f, quad3Alpha);	
	glTexCoord2f(0.5, 0.5);
	glVertex3f(0.0f, 0.0f, 0.0f);
	...
	glBegin(GL_QUADS);
	glColor4f(1.0f, 1.0f, 1.0f, quad4Alpha);	
	glTexCoord2f(1.0, 0.5);
	glVertex3f(1.0f, 0.0f, 0.0f);
...
void update(void)
{
	//Code 
	/*if(quad1Alpha > 0.0f)	
		quad1Alpha = quad1Alpha - 0.0005f;
	else if(quad2Alpha > 0.0f)
		quad2Alpha = quad2Alpha - 0.0005f;
	else if(quad3Alpha > 0.0f)
		quad3Alpha = quad3Alpha - 0.0005f;		
	else if(quad4Alpha > 0.0f)
		quad4Alpha = quad4Alpha - 0.0005f;
	else
		{
			quad1Alpha = 1.0f;
			quad2Alpha = 1.0f;
