# Set parameters
folder = r"D:\RTR\OpenGL\Effects\Marathi_Font_Rendering\Text2Glyph_Converter"
workbook = "Krutidev"
worksheet = "Krutidev"
start_column = "A"
end_column = "N"
...
def Unicode_to_KrutiDev(unicode_substring):
    #modified_substring = bytes(unicode_substring, 'utf-8')
    modified_substring = unicode_substring#unicode_substring.encode('utf-8')
...
# for col in range(start_column_num, end_column_num + 1):
    ...
    # for row in range(start_row_num, end_row_num + 1):
        # excel_file.loc[row, col_name] = function(excel_file.loc[row, col])
