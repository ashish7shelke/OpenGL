...
void draw(void)
{
	...
	if (iPressedKey == 1)
	{
		...
		glBegin(GL_QUADS);
		glTexCoord2f(1.0f, 1.0f);// write top
		...
		glVertex3f(1.0f, -1.0f, 0.0f); // write bottom

		glEnd();

		glBindTexture(GL_TEXTURE_2D, 0);
	}
	else if (iPressedKey == 2)
	{
		glBindTexture(GL_TEXTURE_2D, texture_smiley);

		glBegin(GL_QUADS);
		glTexCoord2f(2.0f, 2.0f);// write top
		glVertex3f(1.0f, 1.0f, 0.0f);

		glTexCoord2f(0.0f, 2.0f); // left top
		glVertex3f(-1.0f, 1.0f, 0.0f);
	...
	else if (iPressedKey == 3)
	{
		glBindTexture(GL_TEXTURE_2D, texture_smiley);

		glBegin(GL_QUADS);
		glTexCoord2f(0.5f, 0.5f);// write top 0.5,0.5
		glVertex3f(1.0f, 1.0f, 0.0f);

		glTexCoord2f(0.0f, 0.5f); // left top 0,0.5
		glVertex3f(-1.0f, 1.0f, 0.0f);

		glTexCoord2f(0.0f, 0.0f);
		glVertex3f(-1.0f, -1.0f, 0.0f); // left bottom 0.0,0.0

		glTexCoord2f(0.5f, 0.0f);
		glVertex3f(1.0f, -1.0f, 0.0f); // write bottom0.5,0
		glEnd();

		glBindTexture(GL_TEXTURE_2D, 0);
	}
	else if (iPressedKey == 4)
	{
		glBindTexture(GL_TEXTURE_2D, texture_smiley);
		...
		glTexCoord2f(0.5f, 0.5f); // left top0.5,0.5
		glVertex3f(-1.0f, 1.0f, 0.0f);

		glTexCoord2f(0.5f, 0.5f);
		glVertex3f(-1.0f, -1.0f, 0.0f); // left bottom all 0.5f 0 pn 

		glTexCoord2f(0.5f, 0.5f);
		glVertex3f(1.0f, -1.0f, 0.0f); // write bottom yellow
		glEnd();
	...
	{
		glBegin(GL_QUADS);
		glVertex3f(1.0f, 1.0f, 0.0f);   //write top
