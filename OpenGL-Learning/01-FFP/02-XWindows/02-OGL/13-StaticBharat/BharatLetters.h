...
void DrawB()
{
	...
	//0.1f adjusted to remove top extra top corners
	glBegin(GL_QUADS);
	glColor4fv(Saffron);
	...
	DrawPartialCircle(0.0f, 0.0f, (fLetterStickHalfHeight / 2.0f) - fLetterStickHalfWidth + 0.075f, 284, 76, White, Saffron, 4);
	glPopMatrix();
	glTranslatef(0.0f, -fLetterStickHalfHeight / 2.0f, 0.0f);
	DrawPartialCircle(0.0f, 0.0f, (fLetterStickHalfHeight / 2.0f) - fLetterStickHalfWidth + 0.075f, 284, 76, Green, White, 3);
...
void DrawA()
{
	...
	glVertex3f((fLetterHalfWidth - fLetterStickHalfWidth) / 2.0, 0.0f, 0.0f);
	glColor4fv(fColor);
	glVertex3f((fLetterHalfWidth - fLetterStickHalfWidth) / 2.0, -fLetterStickHalfHeight / 10.0f, 0.0f);
	glColor4fv(fColor);
	glVertex3f((fLetterHalfWidth + fLetterStickHalfWidth + fLetterHalfWidth * 2.0f) / 2.0, -fLetterStickHalfHeight / 10.0f, 0.0f);
	glEnd();
...
void DrawR()
{
	...
	glBegin(GL_QUADS);
	glColor4fv(White);
	glVertex3f((fLetterHalfWidth + fLetterStickHalfWidth) / 2.0, -0.02f, 0.0f);//0.15f adjusted to lift line up
	glColor4fv(White);
	glVertex3f((fLetterHalfWidth - fLetterStickHalfWidth) / 2.0, -0.02f, 0.0f);//0.15f adjusted to lift line up
	glColor4fv(Green);
