                ...
                case KeyPress:
                    {
                        ...
                        int windowWidth = xwindowAttributes.width;
                        int windowHeight = xwindowAttributes.height;

                        switch (keySymbol)
                        {
                            case XK_0: //0
                            case XK_KP_0: // Numpad 0
                                glViewport(0, 0, (GLsizei)windowWidth, (GLsizei)windowHeight);
                                break;

                            case XK_1: //1
                            case XK_KP_1 : // Numpad 1
                                glViewport(0, 0, (GLsizei)(windowWidth /2), (GLsizei)(windowHeight /2));
                                break;

                            case XK_2: //2
                            case XK_KP_2 : // Numpad 2
                                glViewport((GLsizei)(windowWidth / 2), 0, (GLsizei)(windowWidth / 2), (GLsizei)(windowHeight / 2));
                                break;

                            case XK_3: //3
                            case XK_KP_3 : // Numpad 3
                                glViewport((GLsizei)(windowWidth / 2), (GLsizei)(windowHeight / 2), (GLsizei)(windowWidth / 2), (GLsizei)(windowHeight / 2));
                                break;

                            case XK_4: //4
                            case XK_KP_4 : // Numpad 4
                                glViewport(0, (GLsizei)(windowHeight / 2), (GLsizei)(windowWidth / 2), (GLsizei)(windowHeight / 2));
                                break;

                            case XK_5: //5
                            case XK_KP_5 : // Numpad 5
                                glViewport(0, 0, (GLsizei)windowWidth, (GLsizei)(windowHeight / 2));
                                break;

                            case XK_6: //6
                            case XK_KP_6 : // Numpad 6
                                glViewport(0, (GLsizei)(windowHeight / 2), (GLsizei)windowWidth, (GLsizei)(windowHeight /2));
                                break;

                            case XK_7: //7
                            case XK_KP_7 : // Numpad 7
                                glViewport(0, 0, (GLsizei)(windowWidth /2), (GLsizei)windowHeight);
                                break;
                                
                            case XK_8: //8
                            case XK_KP_8 : // Numpad 8
                                glViewport((GLsizei)(windowWidth / 2), 0, (GLsizei)(windowWidth /2), (GLsizei)windowHeight);
                                break;

                            case XK_9: //9
                            case XK_KP_9 : // Numpad 9
                                glViewport((GLsizei)(windowWidth / 4), (GLsizei)(windowHeight / 4), (GLsizei)(windowWidth / 2), (GLsizei)(windowHeight / 2));
                                break;
