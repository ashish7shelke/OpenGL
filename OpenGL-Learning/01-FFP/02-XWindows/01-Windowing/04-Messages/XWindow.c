    ...
    while(1)
    {
        ...
        switch(event.type)
        {
            ...
            case FocusIn: //SetFocus
                printf("FocusIn Event is received \n");
                break; 
            ...
            case ButtonPress:
                ...
                {
                    case 1:
                        printf("Left Mouse Button Event is received \n");
                        break; 
                    case 2:
                        printf("Middle Mouse Button Event is received \n");
                        break; 
                    case 3:
                        printf("Right Mouse Button Event is received \n");
                        break; 
                }
                break;
          
            case DestroyNotify: // WM_SIZE
