...
GLuint human2_texture1=0; 
GLuint human2_texture2=0;
GLuint human2_texture3=0;
GLuint human2_texture4=0;
GLuint human2_texture5=0;
...
void human2()
{
	...
	glBindTexture(GL_TEXTURE_2D, human2_texture2);
    glRotatef(theta[0], 0.0, 1.0, 0.0);
    torso();
    glBindTexture(GL_TEXTURE_2D, 0);

	glPushMatrix();
	glBindTexture(GL_TEXTURE_2D, human2_texture4);
	glTranslatef(0,TORSO_HEIGHT, 0.0);
	neck();
    glBindTexture(GL_TEXTURE_2D, 0);

	glBindTexture(GL_TEXTURE_2D, human2_texture1);
	glTranslatef(0.0, NECK_HEIGHT+0.5*HEAD_HEIGHT, 0.0);
	glRotatef(theta[1], 1.0, 0.0, 0.0);
    glRotatef(theta[2], 0.0, 1.0, 0.0);
    head();
	...
	glPushMatrix();//add JOINT_POINT_
	glBindTexture(GL_TEXTURE_2D, human2_texture5);
	glTranslatef(-0.85*(TORSO_RADIUS+JOINT_POINT_RADIUS), 
									0.9*TORSO_HEIGHT, 0.0);
	joint_point();
    glBindTexture(GL_TEXTURE_2D, 0);
    ...
    glPushMatrix();
	glBindTexture(GL_TEXTURE_2D, human2_texture3);
	glTranslatef(-(TORSO_RADIUS-JOINT_POINT_RADIUS), 
							-0.15*JOINT_POINT_HEIGHT, 0.0);
	joint_point();
    glBindTexture(GL_TEXTURE_2D, 0);
