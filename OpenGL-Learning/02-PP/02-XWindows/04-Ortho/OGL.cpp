...
vmath::mat4 orthographicProjectionMatrix; //4 by 4 matrix,mat4 is in vmath.h
...
void draw(void)
{
	...
	vmath::mat4 modelViewProjectionMatrix = orthographicProjectionMatrix * modelViewMatrix; // order of multiplication is very imp
