...
{   
	...
	{
		// front
		0.0f, 0.0f, // top-right of front
		1.0f, 0.0f, // top-left of front
		1.0f, 1.0f, // bottom-left of front
		0.0f, 1.0f, // bottom-right of front

		// right
		0.0f, 0.0f, // top-right of right
		1.0f, 0.0f, // top-left of right
		1.0f, 1.0f, // bottom-left of right
		0.0f, 1.0f, // bottom-right of right

		// back
		0.0f, 0.0f, // top-right of back
		1.0f, 0.0f, // top-left of back
		1.0f, 1.0f, // bottom-left of back
		0.0f, 1.0f, // bottom-right of back

		// left
		0.0f, 0.0f, // top-right of left
		1.0f, 0.0f, // top-left of left
		1.0f, 1.0f, // bottom-left of left
		0.0f, 1.0f, // bottom-right of left

		// top
		0.0f, 0.0f, // top-right of top
		1.0f, 0.0f, // top-left of top
		1.0f, 1.0f, // bottom-left of top
		0.0f, 1.0f, // bottom-right of top

		// bottom
		0.0f, 0.0f, // top-right of bottom
		1.0f, 0.0f, // top-left of bottom
		1.0f, 1.0f, // bottom-left of bottom
		0.0f, 1.0f, // bottom-right of bottom
	};
    ...
    {
        fprintf(gpFile,"loadGLTexture(Vijay_Kundali.bmp) Failed\n");
        return -3;
    }
...
GLuint loadGLTexture(const char *path)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, (GLsizei)width, (GLsizei)height, 0, GL_RGB, GL_UNSIGNED_BYTE, (void*)imageData);
...
void draw(void)
{
	...
	vmath::mat4 modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix; // order of multiplication is important
