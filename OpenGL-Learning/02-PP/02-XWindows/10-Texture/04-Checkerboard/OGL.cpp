...
{
	//Variable declarations
	GLfloat square1PosCoord[12];
	GLfloat square2PosCoord[12];
	...
	// Transformation
	vmath::mat4 modelViewMatrix = vmath::translate(0.0f, 0.0f, -6.0f);
	...
	glBindVertexArray(vao);
	glBindBuffer(GL_ARRAY_BUFFER, vbo_position);
	glBufferData(GL_ARRAY_BUFFER, sizeof(square1PosCoord), square1PosCoord, GL_DYNAMIC_DRAW);
	glBindBuffer(GL_ARRAY_BUFFER, 0);
	...
	//glBindVertexArray(vao);
	glBindBuffer(GL_ARRAY_BUFFER, vbo_position);
	glBufferData(GL_ARRAY_BUFFER, sizeof(square2PosCoord), square2PosCoord, GL_DYNAMIC_DRAW);
	glBindBuffer(GL_ARRAY_BUFFER, 0);
	glDrawArrays(GL_TRIANGLE_FAN, 0, 4);
	glBindVertexArray(0);
