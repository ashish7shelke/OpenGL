...
mat4 orthographicProjectionMatrix; //4 by 4 matrix,mat4 is in vmath.h
...
void resize(int width, int height)
{
	...
	// set orthographic projection maatrix
	//	orthographicProjectionMatrix
	if (width <= height)
	{
		orthographicProjectionMatrix = vmath::ortho(-100.0f,                                         // left
			100.0f,                                              // right
			-100.0f * ((GLfloat)height / (GLfloat)width),        // bottom , width is less than height.
	...
	{
		orthographicProjectionMatrix = vmath::ortho(-100.0f * ((GLfloat)width / (GLfloat)height),    // left ,  height is less than width.
...
void display(void)
{
	...
	mat4 modelViewProjectionMatrix = orthographicProjectionMatrix * modelViewMatrix; // order of multiplication is very imp
