...
int initialize(void)
{
	...
	glBindAttribLocation(shaderProgramObject_PV, AGS_ATTRIBUTE_POSITION, "aPosition");
	glBindAttribLocation(shaderProgramObject_PV, AGS_ATTRIBUTE_NORMAL, "aNormal");	
	...
	materialShynessUniform = glGetUniformLocation(shaderProgramObject_PV, "uMaterialShyniness");
...
{
	//Code
	// get PV shader uniform location
	if(bLightingEnabled)
	{
		if(choosenShader == 'V')
		{
