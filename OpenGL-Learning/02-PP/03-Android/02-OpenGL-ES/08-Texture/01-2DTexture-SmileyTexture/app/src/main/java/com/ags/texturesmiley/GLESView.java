...
import com.ags.texturesmiley.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	public GLESView(Context _context)
	{
		...
		this.gestureDetector = new GestureDetector(_context, this, null, false);
    ...
    private void initialize(GL10 gl) {
     ...
     private int loadGLTexture(int imageResourceId)
     {
        ...
        //Create bitmap factory option object
         ...
         Bitmap bitmap = BitmapFactory.decodeResource(this.context.getResources(), imageResourceId, options);
