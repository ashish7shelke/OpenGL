...
import com.ags.tweakedsmiley.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	public boolean onSingleTapConfirmed(MotionEvent e)
	{
        ...
        if(singleTapCounter < 0 || singleTapCounter > 4 ) {
            singleTapCounter = 0;
        }
		return true;
	}
    ...
    private void initialize(GL10 gl) {
        ...
        keyPressedUniform = GLES32.glGetUniformLocation(this.shaderProgramObject, "uKeyPressed");
        ...
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, rectangle_texcoord.length * 4, texureBuffer, GLES32.GL_DYNAMIC_DRAW);
        ...
        textureSmiley[0] = this.loadGLTexture(R.raw.smiley);  
    ...
    private void display() {
        ...
        float[] squareTexCoord = new float[8];
	...
	else
	{
        ...
        ByteBuffer textureByteBuffer = ByteBuffer.allocateDirect(squareTexCoord.length * 4);
        textureByteBuffer.order(ByteOrder.nativeOrder());
        FloatBuffer texureBuffer = textureByteBuffer.asFloatBuffer();
        texureBuffer.put(squareTexCoord);
        texureBuffer.position(0);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, squareTexCoord.length * 4, texureBuffer, GLES32.GL_DYNAMIC_DRAW);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
