package com.ags.texturedpyramid;
...
import com.ags.texturedpyramid.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void initialize(GL10 gl) {
        ...
        ByteBuffer positionByteBuffer = ByteBuffer.allocateDirect(pyramid_position.length * 4);
        ...
        ByteBuffer textureByteBuffer = ByteBuffer.allocateDirect(pyramid_texcoord.length * 4);
        textureByteBuffer.order(ByteOrder.nativeOrder());
        FloatBuffer texureBuffer = textureByteBuffer.asFloatBuffer();
        texureBuffer.put(pyramid_texcoord);
        texureBuffer.position(0);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, pyramid_texcoord.length * 4, texureBuffer, GLES32.GL_STATIC_DRAW);
