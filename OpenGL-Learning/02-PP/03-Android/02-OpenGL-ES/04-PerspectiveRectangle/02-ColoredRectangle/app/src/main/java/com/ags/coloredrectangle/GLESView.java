package com.ags.coloredrectangle;
...
import com.ags.coloredrectangle.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void initialize(GL10 gl) {
        ...
        // Prepare traingle vertices array for GL Buffer array
        // Allocate enough byte buffer
        // Set byte order 
        // Treat this byte araay as float array
        // Fill array in it
        // Set buffer index to 0
        ByteBuffer positionByteBuffer = ByteBuffer.allocateDirect(traingle_position.length * 4);
        positionByteBuffer.order(ByteOrder.nativeOrder());
        FloatBuffer positionBuffer = positionByteBuffer.asFloatBuffer();
        positionBuffer.put(traingle_position);
        positionBuffer.position(0);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, traingle_position.length * 4, positionBuffer, GLES32.GL_STATIC_DRAW);
        ...
        //Vbo color
        GLES32.glGenBuffers(1, this.vbo_color, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, this.vbo_color[0]);
        ByteBuffer colorByteBuffer = ByteBuffer.allocateDirect(triangle_color.length * 4);
    ...
    private void display() {
        ...
        // Draw the triangle
        // 3 is number of vertices in the array i.e. element count in traingle_position divide by 3 (x, y, z) component
    ...
    private void uninitialize() {
        ...
        if(this.vbo_color[0] >= 0)
        {
            GLES32.glDeleteBuffers(1, this.vbo_color, 0);
            this.vbo_color[0] = 0;
        }
