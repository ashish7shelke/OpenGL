...
import com.ags.whitetriangle.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void initialize(GL10 gl) {
        ...
        GLES32.glGenBuffers(1, this.vbo, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, this.vbo[0]);
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(traingle_position.length * 4);
    ...
    private void uninitialize() {
        ...
        if(this.vbo[0] >= 0)
        {
            GLES32.glDeleteBuffers(1, this.vbo, 0);
            this.vbo[0] = 0;
        }
