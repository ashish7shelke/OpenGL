...
import com.ags.coloredcube.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void initialize(GL10 gl) {
        ...
        ByteBuffer cubeByteBuffer = ByteBuffer.allocateDirect(cube_position.length * 4);
    ...
    private void uninitialize() {
        ...
        if(this.vbo_color_cube[0] >= 0)
        {
            GLES32.glDeleteBuffers(1, this.vbo_color_cube, 0);
            this.vbo_color_cube[0] = 0;
        }
