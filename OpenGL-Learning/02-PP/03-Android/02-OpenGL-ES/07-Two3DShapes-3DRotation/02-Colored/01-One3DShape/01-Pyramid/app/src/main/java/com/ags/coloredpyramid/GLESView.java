package com.ags.coloredpyramid;
...
import com.ags.coloredpyramid.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void uninitialize() {
        ...
        if(this.vbo_color_pyramid[0] >= 0)
        {
            GLES32.glDeleteBuffers(1, this.vbo_color_pyramid, 0);
            this.vbo_color_pyramid[0] = 0;
        }
