package com.ags.colored3drotate;
...
import com.ags.colored3drotate.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void initialize(GL10 gl) {
        ...
        //Vbo color
        GLES32.glGenBuffers(1, this.vbo_color_pyramid, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, this.vbo_color_pyramid[0]);
        ByteBuffer pyramidColorByteBuffer = ByteBuffer.allocateDirect(pyramid_color.length * 4);
        pyramidColorByteBuffer.order(ByteOrder.nativeOrder());
        FloatBuffer pyramidColorBuffer = pyramidColorByteBuffer.asFloatBuffer();
        pyramidColorBuffer.put(pyramid_color);
        pyramidColorBuffer.position(0);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, pyramid_color.length * 4, pyramidColorBuffer, GLES32.GL_STATIC_DRAW);
        ...
        GLES32.glGenBuffers(1, this.vbo_color_cube, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, this.vbo_color_cube[0]);
        ByteBuffer cubeColorByteBuffer = ByteBuffer.allocateDirect(cube_color.length * 4);
        cubeColorByteBuffer.order(ByteOrder.nativeOrder());
        FloatBuffer cubeColorBuffer = cubeColorByteBuffer.asFloatBuffer();
